...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 /* [QWERTY] = LAY(
  ...
  [MEDIA] = LAY(
    ...
    KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, U_NA,    U_NU,    KC_LCBR, KC_RCBR, KC_LBRC,    KC_RBRC,
    U_NA,    KC_ALGR, U_NA,    U_NA,    U_NA,    TG(QWERTY),    KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT,
    U_NP,    U_NP,    U_NA,    U_NA,    U_NA,    KC_MSTP, KC_MPLY, KC_MUTE, U_NP,    U_NP
  ),
  [NUM] = LAY(
    KC_LBRC, KC_7,    KC_8,    KC_9,    SELWORD, U_NA,    U_NA,    U_NA,    U_NA,    RESET,
    KC_SCLN, KC_4,    KC_5,    KC_6,    KC_EQL,  U_NA,    KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI,
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_BSLS, U_NA,    U_NA,    U_NA,    KC_ALGR, U_NA,
    U_NP,    U_NP,    KC_DOT,  KC_0,    KC_MINS, U_NA,    U_NA,    U_NA,    U_NP,    U_NP
  ),
  [SYM] = LAY(
    KC_LCBR, KC_AMPR, KC_ASTR, KC_LPRN, SELSENT, U_NA,    U_NA,    U_NA,    U_NA,    RESET,
  ...
  [CODE] = LAY(
    KC_TRNS,   BAND,   EXP,   BOR,   KC_TRNS,   KC_TRNS,   KC_TILD,   KC_GRV,   FAT_ARROW,   KC_TRNS,
    KC_TRNS, NEQ2, NEQ, KC_COLN, KC_TRNS, KC_TRNS, SEMINL, EQ2, EQ3, KC_TRNS,
    KC_TRNS,   GEQ,   LEQ,   U_NA,   KC_TRNS,   KC_TRNS,   U_NA,   COMMENT,   DOTDOT,   KC_TRNS,
    U_NP,    U_NP,    KC_BTN2, KC_SPC,  KC_TAB, KC_ENT,  KC_BSPC, KC_DEL, U_NP,    U_NP
  )
};
